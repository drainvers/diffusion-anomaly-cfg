"""
Train a classifier-free guided diffusion model on images.
"""
import sys
import argparse
import torch as th
...
def main():
    ...
    args.guidance_scale = args.guidance_scale if isinstance(args.guidance_scale, list) else [args.guidance_scale]
