...
class ResBlock(TimestepBlock):
    ...
    def forward(self, x, emb):
        ...
        :param t_emb: an [N x t_emb_channels] Tensor of timestep embeddings.
        :param c_emb: an [N x c_emb_channels] Tensor of conditional embeddings.
        :param mask: an [N x ...] Tensor serving as a context mask for conditional
            embeddings.
...
class UNetModel(nn.Module):
    """
    The full UNet model with attention, timestep, and conditional embedding for
    ...
    def forward(self, x, timesteps, y=None, p_uncond=-1, null=False, clf_free=False):
        """
        ...
        :param p_uncond: Probability of training unconditionally.
        :param null: Zero out embedding if True.
        :param clf_free: Use class conditional embeddings if True.
        :return: an [N x C x ...] Tensor of outputs.
        """
